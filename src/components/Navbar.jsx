  ...
  return (
    <>
      ...
      <div
        className={
          !isOpen
            ? "flex flex-col absolute bg-gradient-to-r from-gray-800 to-gray-900 w-full  h-full text-neutral-200 bottom-full left-0 justify-center items-center gap-16 font-semibold text-xl lg:hidden  transition-all ease-in duration-700 "
            : "flex flex-col absolute bg-gradient-to-r from-gray-800 to-gray-900 w-full h-full text-neutral-200 transition-all bottom-full translate-y-full ease-in duration-700 z-10 left-0 justify-center items-center gap-16 font-semibold text-xl lg:hidden"
        }
      >
        <NavLink
          to="/"
